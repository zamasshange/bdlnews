...
export function categoryFallbackImage(category: Category, seed: string) {
  return CATEGORY_STOCK[category] ?? `https://picsum.photos/seed/${encodeURIComponent(seed)}/1400/900`
}
